...
<!--=====================================
MODAL EDITAR STOCK PRODUCTO
======================================-->

<div id="modalEditarStockProducto" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-header" style="background:#3c8dbc; color:white">
          ...
          <h4 class="modal-title">Editar Stock de producto</h4>
          ...
          <div class="box-body">
             ...
             if($_SESSION["permiteModificarStock"]=='off'){
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control input-lg" id="editarStock" name="editarStock" min="0" placeholder="Ingrese el stock nuevo" required>
