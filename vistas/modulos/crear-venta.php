  ...
  <section class="content">
    <?php
      function readDolarPrice() {
          $stmt = Conexion::conectar()->prepare("SELECT * FROM dolar_today ORDER BY marca_tiempo DESC LIMIT 1");
          $stmt -> execute();

          $result = $stmt->fetchAll();
          $result = $result[0];

          return $result['dolar_sicad2'];
      }

      function dolarIsSaved($timestamp) {
        $stmt = Conexion::conectar()->prepare("SELECT * FROM dolar_today WHERE marca_tiempo=$timestamp");
        $stmt -> execute();
      ...
      function saveDolarPrice() {
        ...
        if (dolarIsSaved($timestamp) == 0) {
            ...
            $stmt = Conexion::conectar()->prepare("INSERT INTO dolar_today(dolar_sicad2, dolar_transferencia, marca_tiempo) VALUES (:dolar_sicad2, :dolar_transferencia, :marca_tiempo)");
      ...
      try {
        saveDolarPrice();
        echo "<p style='font-size: 16px;'>Precio del dolar hoy: ".readDolarPrice(). " Bs</p><br>";
      } catch(Exception $e) {
        echo "<p style='font-size: 16px;'>Precio del dolar hoy: ".readDolarPrice(). " Bs</p><br>";
      }

      echo "<input type='hidden' name='ves' id='ves' value='".readDolarPrice()."'>";
    ?>
               ...
               <div class="input-group date" data-provide="datepicker"  data-date-format="yyyy/mm/dd">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <select class="form-control select2" id="seleccionarCliente" name="seleccionarCliente" required style="width: 80.00%;">

                    <?php
                      if( $cliente["id"]<>0){
                        echo '<option value="'.$cliente["id"].'"> '.$cliente["documento"].'-'.$cliente["nombre"].'</option>';
                      }
                      $item = null;
                      $valor = null;
                    ...
                    <button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#modalAgregarCliente" data-dismiss="modal">Agregar cliente</button>
                  </div>
                  <br>
                </div>
                          ...
                          <td style="width: 30%">
                           ...
                           <td style="width: 40%">
                            ...
                            <div class="input-group">
                              ...
                              <span class="input-group-addon"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total en Bs: </strong></span>

                              <input type="text" class="form-control input-lg" id="totalVES" name="totalVES" total="<?php echo $venta["total_ves"]; ?>" value="<?php echo $venta["total"]; ?>" placeholder="00000" readonly>

                              <input type="hidden" name="totalVentaVES" id="totalVentaVES" value="<?php echo $venta["total_ves"]; ?>">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text"  class="form-control input-lg" name="nuevoDocumentoId" id="nuevoDocumentoId" placeholder="Nro Documento" >
